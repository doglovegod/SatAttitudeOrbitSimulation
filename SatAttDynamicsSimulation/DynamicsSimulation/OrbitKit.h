...
public:
	...
	double LunarPhase(double  jd, double  *pphase, double  *mage, double  *dist, double  *angdia, double  *sudist, double  *suangdia);
	double LunarPhase(double ra1,double dec1,double ra2,double dec2);
	void SatellitePosition(double jd, SATELLITE *pSat);
	void SolarEphemeris(double jd,double *geora,double *geodec,double *geodist,double *geolat,double *geolon,double *x,double *y,double *z);
	void LunarEphemeris(double jd,double *geora,double *geodec,double *geodist,double *geolat,double *geolon,double *px,double *py,double *pz);
	void CalcVisibleCircle(XSegment *visibCirclePix,double circLtd,double circLng,double circHgt,double halfAngle,int rangex,int rangey,double ratiox,double ratioy);
	void CalcVisibleCircle(double CirclePixel[NSEGSVC][3],double circLtd,double circLng,double circHgt,double halfAngle,double alphaG);
	void CalcVisibleLine(XSegment *visibCirclePix,double circLtd,double circLng,double circHgt,double halfAngle,double inc,int rangex,int rangey,double ratiox,double ratioy);
	void CalcSBSIntersect(double o_ll[],double satLtd,double satLng, double satHgt,double halfAngle,double inc,double theta=0);
//	void RV2OE(double o_oe[],double i_rv[]);
	...
	vector_t sunSpacecraftVector(vector_t sat, vector_t sun);
	double isInShadow(vector_t sat, vector_t sun);
	bool isInShadow(double& nu, vector_t sat, vector_t sun);
};
